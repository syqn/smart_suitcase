...
DEV_GPIO_INT_CFG DWM1000_set_echo;
DEV_GPIO_BIT_ISR DWM1000_get_echo;
...
#define EMSK_DWM1000_RES_OFFSET		(16)
#define EMSK_DWM1000_RES_MASK		((0x01) << EMSK_DWM1000_RES_OFFSET)
#define DWM1000_IRQ_offset  (16)
#define DWM1000_IRQ_mask    ((0x01) << DWM1000_IRQ_offset)
